const enemyData = {
numbers: {
  1: { name: "Green Slime", hp: 80, attack: 15, img: "assets/enemy/slime.png" },
  2: { name: "Red Mite", hp: 100, attack: 20, img: "assets/enemy/mite.png" },
  3: { name: "Beetle", hp: 130, attack: 25, img: "assets/enemy/beetle.png" },
  4: { name: "Stone Golem", hp: 180, attack: 35, img: "assets/enemy/golem.png" },

  5: { name: "Fraction Frog", hp: 200, attack: 25, img: "assets/enemy/frog.png" },
  6: { name: "Decimal Wolf", hp: 220, attack: 30, img: "assets/enemy/wolf.png" },
  7: { name: "Compare Owl", hp: 240, attack: 35, img: "assets/enemy/owl.png" },
  8: { name: "Order Sprite", hp: 260, attack: 45, img: "assets/enemy/spirit1.png" },

  9: { name: "Prime Spirit", hp: 280, attack: 40, img: "assets/enemy/spirit2.png" },
  10:{ name: "Factor Bunny", hp: 300, attack: 45, img: "assets/enemy/bunny.png" },
  11:{ name: "Guardian Snake", hp: 330, attack: 50, img: "assets/enemy/snake.png" },
  12:{ name: "Titan Monkey", hp: 360, attack: 60, img: "assets/enemy/monkey.png" },

  13:{ name: "Fox Mage", hp: 400, attack: 50, img: "assets/enemy/fox.png" },
  14:{ name: "Tiger Knight", hp: 430, attack: 55, img: "assets/enemy/tiger.png" },
  15:{ name: "Phantom Rat", hp: 470, attack: 60, img: "assets/enemy/rat.png" },
  16:{ name: "Radical Bat", hp: 520, attack: 70, img: "assets/enemy/bat.png" },

  17:{ name: "Titan Griffin 👑", hp: 700, attack: 80, img: "assets/enemy/griffin.png" }
},
